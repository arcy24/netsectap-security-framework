...
**Command:**
```
assess n8n.netsectap-labs.com
```

**Output (in terminal):**
```
============================================================
Web Security Assessment - n8n.netsectap-labs.com
============================================================
...
Full report saved: n8n-netsectap-labs-com.md
============================================================
```
...
```json
{
  "assessment_preferences": {
    ...
    "default_recipient": "rcaparros@netsectap-labs.com"
  },
  "report_settings": {
...
✅ PDF generated: n8n-netsectap-labs-com.pdf
✅ Email sent to: rcaparros@netsectap-labs.com
```
...
```
n8n.netsectap-labs.com,90,A,0,0,2
```
...
```
assess n8n.netsectap-labs.com --send-email
```

### Specify Format
```
assess n8n.netsectap-labs.com --format detailed
```

### Specify Recipient
```
assess n8n.netsectap-labs.com --to security@example.com
```
...
**Command:**
```
assess api.netsectap-labs.com --cli-only --format summary
```
...
```
Command: `re-assess n8n.netsectap-labs.com`
