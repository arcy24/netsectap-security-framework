...
```bash
# Simple one-liner
claude "assess https://example.netsectap-labs.com and send report"
```
...
```bash
# Quick CLI check
assess n8n.netsectap-labs.com --cli-only

# Send to client
assess client-site.com and send report --to client@example.com

# Detailed terminal output
assess api.netsectap-labs.com --format detailed
```
...
**Command:**
```
assess n8n.netsectap-labs.com and send report
```
...
**Command:**
```
assess n8n.netsectap-labs.com (don't send)
```
...
**Command:**
```
assess and fix n8n.netsectap-labs.com
```
...
```bash
# You say:
assess api.netsectap-labs.com and send report

# Claude does (no prompts):
1. Runs DNS, SSL, headers, tech detection
2. Generates report → api-netsectap-labs-com.md
3. Creates PDF → api-netsectap-labs-com.pdf
4. Sends to: rcaparros@netsectap-labs.com
...
```bash
# You say:
re-assess n8n.netsectap-labs.com and send report
...
{
  "assessment_preferences": {
    "default_recipient": "security@netsectap.com"
  }
}
```
...
# Run assessment
./run-assessment.sh n8n.netsectap-labs.com --auto-send
...
1. **Use clear domain names:**
   - ✅ Good: `assess n8n.netsectap-labs.com`
   - ❌ Ambiguous: `assess n8n`
...
**Zero-Prompt Command:**
```
assess [domain].netsectap-labs.com and send report
```
