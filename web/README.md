...
```bash
cd /path/to/security-assessments/web
python3 send-report.py example-domain-com.md
```

#### Send to Specific Client

```bash
python3 send-report.py example-domain-com.md client@example.com
```
...
============================================================
Report: example-domain-com.md
Domain: app.example.com
Sender: security@example.com
Auth: Microsoft Graph API (OAuth2)
============================================================

📄 Converting example-domain-com.md to PDF...
✅ PDF created: example-domain-com.pdf
...
```bash
cd /path/to/security-assessments
...
├── example-domain-com.md     # Example: OpenLLM assessment
├── www.example.com-assessment.md   # Example: Main site assessment
...
- **GitHub Issues:** [Report an issue](https://github.com/arcy24/netsectap-security-framework/issues)
- **Documentation:** See [../README.md](../README.md)

---

**© 2025 NetSecTap Security Framework** - Open Source Security Assessment Tools
