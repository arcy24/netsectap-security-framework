...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python3 send-report.py openllm.netsectap-labs-com.md")
        print("  python3 send-report.py openllm.netsectap-labs-com.pdf")
        print("  python3 send-report.py openllm.netsectap-labs-com.pdf client@example.com")
